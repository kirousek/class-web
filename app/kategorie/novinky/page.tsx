            ...
            <div className="flex flex-col flex-grow">
                <div className="p-5">
                    <div className="max-w-3xl mx-auto text-center items-center mt-10 py-10">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-snug md:leading-snug lg:leading-snug xl:leading-snug">Novinky</h1>
                        <div className="md:text-lg py-10">
                            <p className="text-gray-500">Všechno o tom co se aktuálně děje ve třídě</p>
                        </div>
                    </div>
                </div>
                <div className="m-5 flex-grow max-w-screen-lg lg:mx-auto lg:flex lg:flex-wrap">
                    <div className="lg:pr-20 lg:w-2/3">
                        <div className="my-20">
                            <Link className="group focus:outline-none" href="/kategorie/posts/divadlo">
                                ...
                                <p className="my-5 text-lg text-gray-500">
                                    Dne 13.4. jde naše třida do divadla...
                                </p>
                            </Link>
                        </div>
                    </div>
