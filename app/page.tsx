        ...
        <div className="flex flex-col flex-grow">
            <div className="p-5">
                <div className="max-w-3xl mx-auto text-center items-center mt-10 py-10">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-snug md:leading-snug lg:leading-snug xl:leading-snug">Třída EP1B</h1>
                    <div className="md:text-lg py-10">
                        <p className="text-gray-500">Stránky třídy EP1B na palachovi.</p>
                    </div>
                </div>
            </div>
